...
public class OtherConfidentialDetailsMain {
	...
	private static void editData(UserConfidentialDetailsRepository userConfidentialDetailsRepository,int userId,int dataId) 
	{
		...
		boolean isEdited=userConfidentialDetailsRepository.editUserConfidentialDetails(dataId,userId,new UserConfidentialDetails(typeOfData,requiredInformation));
	...
	private static void addData(UserConfidentialDetailsRepository userConfidentialDetailsRepository,int userId) {
		...
		System.out.println("Required information");
		String requiredInformation = scanner.nextLine();
		userConfidentialDetailsRepository.addUserConfidentialDetails(new UserConfidentialDetails(userId,typeOfData,requiredInformation));
